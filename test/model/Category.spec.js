...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamplePetClinicPlay26Apis.Category();
  });
  ...
  describe('Category', function() {
    it('should create an instance of Category', function() {
      ...
      //var instane = new SamplePetClinicPlay26Apis.Category();
      //expect(instance).to.be.a(SamplePetClinicPlay26Apis.Category);
    });
